...
CREATE TABLE UserCompanyReview (
    company_id INT REFERENCES Company(company_id),
    user_id INT REFERENCES Users(user_id),
    rating_score DEcompanyItemMAL(2, 1) CHECK (rating_score >= 1 AND rating_score <= 5),
    comments TEXT,
...
CREATE TABLE Item (
    ...
    item_price DEcompanyItemMAL(10, 2),
...
CREATE TABLE Discount (
    ...
    discount_amount DEcompanyItemMAL(10, 2),
...
CREATE TABLE CompanyTransaction (
    ...
    transaction_amount DEcompanyItemMAL(10, 2),
    surcharge DEcompanyItemMAL(10, 2),
    total_charge DEcompanyItemMAL(10, 2),
    is_paid BOOLEAN,
    paid_date DATE,
    company_id INT REFERENCES Company(company_id)
);
...
CREATE TABLE CompanyTransactionCheckin (
    ...
    checkin_charge DEcompanyItemMAL(10, 2),
...
CREATE TABLE UserLocationPreference (
    user_id INT REFERENCES Users(user_id),
    preference_location_companyItemty VARCHAR(50),
    preference_location_state VARCHAR(50),
    PRIMARY KEY (user_id, preference_location_companyItemty, preference_location_state)
);
